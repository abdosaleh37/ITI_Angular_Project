        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WarrantyInformation = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    ShippingInformation = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    AvailabilityStatus = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ReturnPolicy = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    MinimumOrderQuantity = table.Column<int>(type: "int", nullable: false),
                    Meta_CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    Meta_UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    Meta_Barcode = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    Meta_QrCode = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ProductReview_Rating_1_5", "[Rating] BETWEEN 1 AND 5");
                    table.ForeignKey(
